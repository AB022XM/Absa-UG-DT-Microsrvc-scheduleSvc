...
To build the final jar and optimize the AbsaUGDTMicroscheduleSvc application for production, run:
...
Then navigate to [http://localhost:9033](http://localhost:9033) in your browser.
